...
public class SysuserController extends BaseController {
    ...
    //商家信息
    @ResponseBody
    @RequestMapping("admin/sjShow")
    public HashMap<String, Object> sjShow(String id,
            HttpServletRequest request) {
        HashMap<String, Object> res = new HashMap<String, Object>();
        Sysuser user = sysuserDAO.findById(Integer.valueOf(id));
        res.put("user", user);
        return res;
    }
